...
class TransferController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.practice_tree.transfer.index',$data);
    }
        ...
        if($count_deposit == 0){
            ...
            if ($validator->fails()) {
                ...
                if($deposit->save()){
                    ...
                    $transaction->transaction_type ="TF";
                    ...
                    DB::commit();
                    \Session::flash('success', 'You are success transfer to '.''.$transaction->account_no.''.$request['amount']);
                }else{
                    DB::rollBack();
                    \Session::flash('error', 'You are failed in inputing your data !!!');
                }
